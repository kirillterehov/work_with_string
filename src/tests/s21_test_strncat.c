...
START_TEST(strncat_1) {
  char s1[30] = "sgsdgfdsgedfsgsdfg";
  char s2[30] = "sgsdgfdsgedfsgsdfg";
  char s3[] = "sgsdgfdsgedfsgsdfg";
  s21_size_t n = 1;
...
START_TEST(strncat_6) {
  char s1[100] = "sgsdgfdsgedfsgsdfg";
  char s2[100] = "sgsdgfdsgedfsgsdfg";
  char s3[] = "ofjaslfskajflkjfgjlbjldbkvfvdf";
  s21_size_t n = 6;
  ck_assert_pstr_eq(strncat(s1, s3, n), s21_strncat(s2, s3, n));
}
END_TEST
...
START_TEST(strncat_10) {
  char s1[100] = "dedea\0, ccccc!";
  char s2[100] = "dedea\0, ccccc!";
  char s3[] = "3245235435\0fdf534534534534!.";
  s21_size_t n = 15;
  ck_assert_pstr_eq(strncat(s1, s3, n), s21_strncat(s2, s3, n));
}
END_TEST
...
START_TEST(strncat_15) {
  char s1[100] = "sgsdgfdsgedfsgsdfg\0\0\0";
  char s2[100] = "sgsdgfdsgedfsgsdfg\0\0\0";
  char s3[] = "dfafafafafasfafefg";
  s21_size_t n = 0;
  ck_assert_pstr_eq(strncat(s1, s3, n), s21_strncat(s2, s3, n));
}
END_TEST
