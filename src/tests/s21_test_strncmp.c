...
START_TEST(strncmp_1) {
  char s1[] = "fasfasfasfasfas";
  char s2[] = "fasfasfasfasfas";
  s21_size_t n = 14;
...
START_TEST(strncmp_6) {
  char s1[] = "647456875685345";
  char s2[] = "647456875685345";
  s21_size_t n = 5;
  int n1 = strncmp(s1, s2, n);
  n1 = n1 > 0 ? 1 : n1 == 0 ? 0 : -1;
  int n2 = s21_strncmp(s1, s2, n);
...
START_TEST(strncmp_8) {
  char s1[] = "75675674675674";
  char s2[] = "f6453645645645";
  s21_size_t n = 0;
  int n1 = strncmp(s1, s2, n);
  n1 = n1 > 0 ? 1 : n1 == 0 ? 0 : -1;
  int n2 = s21_strncmp(s1, s2, n);
